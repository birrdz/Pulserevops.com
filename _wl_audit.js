...
const dns=(idx.entries||[]).filter(e=>e&&/^wl\d+$/.test(e.id)).sort((a,b)=>a.id.localeCompare(b.id));
let allClean=true;
...
if(e.id==='wl0001'||e.id==='wl0002')fs.writeFileSync('C:/Users/koryj/_'+e.id+'_view.md',b);}

...
const dns=(idx.entries||[]).filter(e=>e&&/^rs\d+$/.test(e.id)).sort((a,b)=>a.id.localeCompare(b.id));
let allClean=true;
...
if(e.id==='rs0001'||e.id==='rs0002')fs.writeFileSync('C:/Users/koryj/_'+e.id+'_view.md',b);}

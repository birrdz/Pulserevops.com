...
const dns=(idx.entries||[]).filter(e=>e&&/^tv\d+$/.test(e.id)).sort((a,b)=>a.id.localeCompare(b.id));
let allClean=true;
...
if(e.id==='tv0001'||e.id==='tv0002')fs.writeFileSync('C:/Users/koryj/_'+e.id+'_view.md',b);}

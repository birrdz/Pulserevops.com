...
const steps = [
  ['node _es_seo_sync_hub.js', 'hub SEO sync'],
  ['node _es_seo_optimize.js', 'blob SEO optimize all es'],
  ['node _seo_pillar_verify.js es', 'pillar SEO spot-check (es hub + sample)'],
];
...
(async () => {
  ...
  fs.writeFileSync(
    'C:/Users/koryj/website/_es_finish_report.json',

...
const dns=(idx.entries||[]).filter(e=>e&&/^lv\d+$/.test(e.id)).sort((a,b)=>a.id.localeCompare(b.id));
let allClean=true;
...
if(e.id==='lv0001'||e.id==='lv0002')fs.writeFileSync('C:/Users/koryj/_'+e.id+'_view.md',b);}

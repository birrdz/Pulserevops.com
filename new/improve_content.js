...
function buildPrompt(question, body) {
  return [
    ...
    '',
    'THE SHAPE IS FIXED. Copy this skeleton exactly and change ONLY the content. Every Q&A page on this',
    'site has the SAME structure, the SAME section count and the SAME paragraph count — the topic, the',
    'angle and the vibe change, the shape never does.',
    '',
    '## Direct Answer',
    '<ONE paragraph, 40-60 words, that fully and quotably answers the question. A reader who stops here',
    ' is answered. No bullets, no diagram, no list. This is the featured-snippet target — keep it tight.>',
    '',
    '## <Plain topical heading 1>',
    '<EXACTLY 2 paragraphs, 110-150 words each.>',
    '',
    '## <Plain topical heading 2>',
    '<EXACTLY 2 paragraphs, then ONE ```mermaid flowchart TD``` block. This is the TOP diagram.>',
    '',
    '## <Plain topical heading 3>',
    '## <Plain topical heading 4>',
    '## <Plain topical heading 5>',
    '## <Plain topical heading 6>',
    '## <Plain topical heading 7>',
    '## <Plain topical heading 8>',
    '## <Plain topical heading 9>',
    '<each of headings 3 through 9: EXACTLY 2 paragraphs, 110-150 words each.>',
    '',
    '## <Plain topical heading 10>',
    '<EXACTLY 2 paragraphs, then ONE ```mermaid flowchart TD``` block. This is the BOTTOM diagram, and',
    ' it must be a DIFFERENT diagram from the top one.>',
    '',
    '## Related questions',
    '<3-5 "### Question?" sub-questions, each answered in <= 50 words>',
    '',
    '## FAQ',
    '<5-6 pairs, each a bold "**Question?**" line then an answer paragraph of 40-80 words>',
    '',
    '## Sources',
    '<5-10 real, verifiable external URLs as bullets. NEVER cite pulserevops.com. NEVER invent one.>',
    '',
    '## Related on PULSE',
    '<3-6 sibling-topic bullet links>',
    '',
    'HARD RULES (violating any = rejected):',
    '- EXACTLY 10 content sections between the Direct Answer and "## Related questions". Ten — because',
    '  each one carries one image, and every page on this site has a hero card plus 10 body images.',
    '- EXACTLY 2 paragraphs under every one of those 10 headings. The same everywhere.',
    '- EXACTLY 2 ```mermaid``` blocks: one at the TOP (section 2), one at the BOTTOM (section 10).',
    '  They must be different diagrams. Two — never one, never three.',
    '- 2,600-3,200 words total. 2,600 is a HARD FLOOR — a page under 2,500 words is REJECTED by the',
    '  publish gate no matter how good it is, so never stop short. Ten sections x two paragraphs of',
    '  110-150 words lands in band naturally.',
    '- Plain topical H2s only. NEVER numbered ("## 1.") — numbered headings are the Top-10 template.',
    '- NO "## TL;DR", ever. NO image markdown ![...](...) — the machine places every image.',

...
function buildPrompt(question, body) {
  return [
    ...
    '<EXACTLY 3 paragraphs, 90-130 words each.>',
    '',
    '## <Plain topical heading 2>',
    '<EXACTLY 3 paragraphs, 90-130 words each, then ONE ```mermaid flowchart TD``` block. This is the',
    ' TOP diagram.>',
    '',
    ...
    '<EXACTLY 3 paragraphs, 90-130 words each, then ONE ```mermaid flowchart TD``` block. This is the',
    ' BOTTOM diagram, and it must be a DIFFERENT diagram from the top one.>',
    '',
    '## Related questions',
    ...
    '',
    'HARD RULES (violating any = rejected):',
    '- EXACTLY 5 content sections between the Direct Answer and "## Related questions". Not 3, not 6.',
    '- EXACTLY 3 paragraphs under every one of those 5 headings. The same everywhere.',
    '- EXACTLY 2 ```mermaid``` blocks: one at the TOP (section 2), one at the BOTTOM (section 5).',
    ...
    '  publish gate no matter how good it is, so never stop short. Five sections x three paragraphs of',
    '  90-130 words lands in band naturally.',

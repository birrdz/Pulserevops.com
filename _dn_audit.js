...
const dns=(idx.entries||[]).filter(e=>e&&/^dn\d+$/.test(e.id)).sort((a,b)=>a.id.localeCompare(b.id));
let allClean=true;
...
if(e.id==='dn0004'||e.id==='dn0001')fs.writeFileSync('C:/Users/koryj/_'+e.id+'_view.md',b);}

...
const steps = [
  ['node _dn_seo_sync_hub.js', 'hub SEO sync'],
  ['node _dn_seo_optimize.js', 'blob SEO optimize all dn'],
  ['node _seo_pillar_verify.js', 'pillar SEO spot-check (dn hub + sample)'],
];
...
(async () => {
  ...
  fs.writeFileSync(
    'C:/Users/koryj/website/_dn_finish_report.json',

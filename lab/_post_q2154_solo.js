const fs = require('https') && require('fs');
const https = require('https');

const body = fs.readFileSync('C:/Users/koryj/website/lab/_gold_q2154_solo.md', 'utf8');
const payload = {
...
console.log('id=' + payload.id, 'format_v=' + payload.format_v,
            ...
            'word_count=' + payload.new_answer.trim().split(/\s+/).length,

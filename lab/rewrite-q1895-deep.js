...
const tags = ['b2b-saas','pricing-strategy','hightouch','zoominfo','consumption-pricing','warehouse-native','competitive-strategy','reverse-etl','go-to-market','modern-data-stack'];

const sources = [
  { title: 'ZoomInfo Technologies (NASDAQ: ZI) -- Investor Relations and SEC Filings', url: 'https://ir.zoominfo.com' },
  { title: 'Hightouch -- Company Site and Product Documentation', url: 'https://hightouch.com' },
  { title: 'OpenView Partners -- Usage-Based Pricing Research', url: 'https://openviewpartners.com' }
];

const notes = {
  s6: 'Added 35 cited sources: ZoomInfo investor relations and FY2024 earnings materials (revenue, retention, market-cap re-rating, per-seat model), Hightouch company and product documentation plus the 2022 Series C announcement (Sapphire/ICONIQ, ~$1.2B valuation) and pricing page, the warehouse-native peer set (Census, Fivetran, dbt Labs, Snowflake, Databricks) for pricing-pattern reference, usage-based-pricing research from OpenView, Bessemer, a16z, Tomasz Tunguz, and Kyle Poyar, analyst coverage from Gartner and Forrester on the sales-intelligence and CDP categories, competitor references (Apollo, Cognism, Clearbit), consumption-pricing public-company case studies (Datadog, MongoDB, Snowflake NRR), and SaaS benchmark sources (SaaS Capital, Battery, Iconiq, ProfitWell/Paddle, CB Insights, G2).',
  s7: 'Added comprehensive numbers block: ZoomInfo structural profile (~$1.2B FY2024 revenue, market cap from $30B+ peak to ~$4-5B, $15K-$40K small-team and $40K-$250K+ enterprise seat contracts); Hightouch structural profile (founded 2018, $38M Series C, ~$1.2B valuation, warehouse-native architecture, no seat unit); the recommended three-part structure as a table (flat platform fee $24K-$150K/yr, consumption add-on $0.40-$1.50 per 1,000 enriched/scored records, free tier under ~10K records/month); platform-fee tiering inputs; a Hightouch-vs-ZoomInfo representative-cost table across four customer profiles; a meter-unit evaluation table scoring five candidate meters against four tests; the consumption guardrails; the warehouse-native peer-set pricing patterns; and the four-phase rollout. Three real markdown pipe tables in this block plus one in core.',
  s8: 'Added 10-element counter-case: procurement is built to buy seats, revenue predictability genuinely suffers under consumption, bill shock can lose deals, ZoomInfos proprietary data scale is a real product advantage pricing cannot solve, the free tier has real costs and abuse vectors, consumption pricing can suppress the very usage Hightouch wants, mid-market may not be the right beachhead, a hybrid may beat a pure model, ZoomInfo could respond faster than assumed, and metering-infrastructure execution risk is high -- closed with an honest conditional verdict that the model is right but only with strong guardrails, committed-use options, a possible hybrid release valve, real metering investment, and the acknowledgment that pricing cannot substitute for closing a genuine product gap.',
  s9: 'Cross-linked 25 related Pulse entries spanning competitive positioning and go-to-market (q1893, q1894, q1905, q9803), pricing-model mechanics (q1896, q1899, q1900, q1903, q1904, q9802), product-led growth and free-tier strategy (q1897), incumbent-response dynamics (q1898), the modern data stack and reverse-ETL category (q1901, q1909, q9701), buyer-persona and sales-motion alignment (q1902), investor-facing pricing narrative (q1906), phased rollout and deal discipline (q1907, q1908), consumption-pricing case studies (q1910), CFO and billing-infrastructure operations (q9601, q9602), the B2B sales-intelligence market outlook (q9801), and the unit-economics and scaling parallels in the q9501/q9502 benchmark pair.',
  s10: 'SUBAGENT_VERIFIED. Comprehensive deep-rewrite of the B2B-SaaS competitive-pricing-strategy question "How should Hightouch price pipeline analytics against ZoomInfo equivalent?" -- written as a competitive/pricing-strategy deep dive, not a how-to-start-a-business entry, and rewriting the EXISTING q1895 entry (not creating a new one). Verified structure: tldr opens with TL;DR and the full recommendation (warehouse-native consumption-plus-platform model, explicit refusal of per-seat pricing, the three-part structure with concrete ranges, the three traps to avoid); core contains 20 deep H2 sections -- what the question is really asking, structural profiles of both companies, what pipeline analytics means here, why per-seat structurally cannot work for Hightouch, the warehouse-native peer-set pattern, the recommended structure tier by tier, a direct Hightouch-vs-ZoomInfo comparison (with a pipe table), choosing the consumption meter unit, margin architecture and the data-vendor trap, the free tier as strategic weapon, land-and-expand mechanics under each model, sales-motion and buyer-persona alignment, why ZoomInfo is structurally constrained from responding, packaging the platform fee versus the meter, discounting and deal discipline, the bill-shock risk and its defenses, what the pricing says to investors, a phased rollout plan, the counter-pressure where seat pricing looks tempting, and the recommendation in one frame. flow contains exactly 2 mermaid diagrams (the pricing-decision flow from structural facts to final model, and the buyer-and-margin map). src has 35 cited sources with real companies and URLs (ZoomInfo IR, Hightouch, Census, Fivetran, dbt, Snowflake, Databricks, OpenView, Bessemer, a16z, Gartner, Forrester, Datadog, MongoDB, etc.); num is a comprehensive benchmark block with four pipe tables; counter is a 10-element counter-case with a conditional verdict; links cross-references 25 related entries. Real named companies, real reported numbers, real source URLs throughout; direct operator/strategist voice; no AI-tells, no smart quotes, no em-dashes.'
};

runPolish({ id: 'q1895', tldr, core, flow, src, num, counter, links, sources, tags, notes }).catch(e => { console.error(e); process.exit(1); });

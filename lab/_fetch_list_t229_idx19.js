...
https.get('https://pulserevops.com/.netlify/functions/pulse-machine-library-list?recent=5000', res => {
  ...
  res.on('end', () => {
    ...
    fs.writeFileSync('C:/Users/koryj/website/lab/_list_t229_idx19.json', JSON.stringify(j));
    ...
    const target = elig[19];
    console.log('TARGET idx19 = ' + (target ? target.id + ' :: ' + target.question : 'NONE'));
    if (target) fs.writeFileSync('C:/Users/koryj/website/lab/_target_t229_idx19.json', JSON.stringify(target));
  });

...
const p = JSON.parse(fs.readFileSync('C:/Users/koryj/website/lab/_payload_q1849_solo.json', 'utf8'));
if (!p.polish_note || p.polish_note.length < 8) p.polish_note = 'v15.2 batch gold-upgrade';

...
// Target window: 8,500-9,800 words (HARD CAP 10,500). Lean paragraphs, frequent H3 breaks.
...
> - **[Decision framework]** The Sales Engagement Platform (SEP) choice in 2027 is a **four-variable function**: **(1) company size + rep count**, **(2) buyer ICP and ACV band**, **(3) existing CRM + data + dialer stack**, **(4) all-in budget per rep per year**. The three dominant vendors map cleanly: **[Outreach](https://www.outreach.io/)** (Manny Medina co-founder, last private valuation **$4.4B**, post-RIF resetting) is the **enterprise-default** for **50+ reps, $50K+ ACV, Salesforce-native shops with budget for the admin overhead**; **[Salesloft](https://salesloft.com/)** (David Obrand CEO, Vista-backed at **~$2.3B**, Drift conversational AI built-in post-acquisition) is the **mid-market-to-enterprise sweet spot** for **15-300 reps, $10K-$250K ACV, multi-team RevOps that wants lower admin overhead**; **[Apollo](https://www.apollo.io/)** (Tim Zheng founder, freemium + **~260M-contact B2B database**) is the **all-in-one SMB-and-mid-market commodity displacer** for **5-100 reps, $1K-$30K ACV, teams that want data + sequences + dialer + scheduler + analytics in one contract for a fraction of the Outreach price**. **Honorable mentions** that win specific contexts: **[Gong Engage](https://www.gong.io/products/engage/)** (free with Gong, the conversation-intelligence-first play), **[HubSpot Sequences](https://www.hubspot.com/products/sales/sequences)** (free with Sales Hub Pro+, the CRM-native play), **[Reply.io](https://reply.io/) / [Lemlist](https://lemlist.com/) / [Smartlead](https://www.smartlead.ai/) / [Instantly](https://instantly.ai/) / [MixMax](https://www.mixmax.com/)** (sub-$50/user/mo SMB and outbound-agency tools).
> - **[Why one feature comparison is not enough]** Buying a SEP on a feature checklist is the #1 wasted-software-spend pattern in B2B SaaS — the **commoditized core** (multi-channel sequences, A/B testing, send windows, reply detection, snooze logic, basic dialer, basic reporting) is **table-stakes across all three vendors** in 2027. The actual differentiation lives on **six load-bearing axes**: **(1) data layer** (Apollo wins on built-in B2B database, the others require ZoomInfo/Cognism/Lusha attach), **(2) sequence engine** (Outreach has the deepest variant logic, Salesloft has the cleanest UX, Apollo has the fastest setup), **(3) dialer + parallel-dial** (Outreach Voice + Salesloft Dialer mature; Apollo dialer functional but newer; specialized power-dialers Orum/Nooks/ConnectAndSell still win for true parallel-dial), **(4) conversation intelligence** (Outreach has Sameplan-acquired CI, Salesloft has Drift built-in, Apollo has basic CI; Gong/Chorus integration is the heavyweight option), **(5) integration depth** (Salesforce-native execution: Outreach > Salesloft > Apollo; HubSpot-native: Apollo > Salesloft > Outreach), **(6) admin overhead** (Outreach requires dedicated admin headcount, Salesloft middle, Apollo lowest). Plus the **gating two**: **rep adoption** (the tool reps actually open daily beats the tool with more features 10:1) and **playbook + data quality** (no SEP fixes broken targeting or generic copy). The four classic failure modes: **under-utilization** (only 30% of seats actually sequence weekly), **enterprise-tool-for-SMB** (Outreach for 8 reps = wasted spend), **spray-and-pray reputation destruction** (high-volume + low-personalization = domain blacklisting in 6 months), **no-playbook chaos** (every rep invents their own sequences = no compounding learning).
> - **[The pricing reality in 2027]** Public-facing pricing is a starting position; real enterprise deals get negotiated 20-40% off list once you have 50+ seats. The **all-in cost-per-rep-per-year** ranges are: **Outreach $1,600-$2,200/rep/yr** + **$20-50K onboarding** + **0.5-1.0 FTE admin overhead**; **Salesloft $1,300-$1,900/rep/yr** + **$10-25K onboarding** + **0.25-0.75 FTE admin**; **Apollo $0 free → $588-$1,788/rep/yr** + **$0-5K onboarding** + **0.1-0.4 FTE admin**; **Gong Engage included** with Gong CI license (~**$1,500/rep/yr** for the Gong side); **HubSpot Sequences included** with Sales Hub Pro ($90/user/mo) or Enterprise ($150/user/mo). The hidden cost: **data attach** (ZoomInfo $15-25K minimum, Cognism $20-40K, Lusha $5-15K) is **mandatory for Outreach and Salesloft** unless you bring your own data — Apollo bundles this. Migration realities are brutal: **Outreach → Salesloft = 6-8 weeks** of pain (sequence mapping + admin retraining); **Salesloft → Apollo = 2-3 weeks** (Apollo's import tooling is strong); **Apollo → Outreach = 4-6 weeks** (the opposite direction is harder because Outreach demands more configuration). The benchmark sources for this decision: **[G2 Grid for Sales Engagement](https://www.g2.com/categories/sales-engagement)**, **[Forrester Wave Sales Engagement Platforms](https://www.forrester.com/)**, **[Gartner Magic Quadrant for Sales Engagement Applications](https://www.gartner.com/)**, **[OpenView SaaS Benchmarks](https://openviewpartners.com/expansion-saas-benchmarks/)**, and the **[Bridge Group SDR Metrics Report](https://bridgegroupinc.com/)** for activity benchmarks that contextualize what good usage looks like.`;

const core = `

The **sales engagement platform (SEP)** category in 2027 is a three-vendor oligopoly with a long tail of honorable mentions, and the choice you make is far less about features than the vendor marketing wants you to believe. **[Outreach](https://www.outreach.io/)**, **[Salesloft](https://salesloft.com/)**, and **[Apollo](https://www.apollo.io/)** collectively control roughly **70-80% of paid SEP seats** in the U.S. mid-market and enterprise, with **Outreach** holding the enterprise high ground, **Salesloft** punching above its weight in mid-market, and **Apollo** aggressively eating SMB and lower-mid-market share through a freemium model and a bundled B2B database. The honorable mentions — **[Gong Engage](https://www.gong.io/products/engage/)**, **[HubSpot Sequences](https://www.hubspot.com/products/sales/sequences)**, **[Reply.io](https://reply.io/)**, **[Lemlist](https://lemlist.com/)**, **[MixMax](https://www.mixmax.com/)**, **[Smartlead](https://www.smartlead.ai/)**, **[Instantly](https://instantly.ai/)** — win specific niches but rarely beat the big three in head-to-head enterprise evaluations.

The vendor pitch you will hear from each will sound roughly the same: **multi-channel sequences, AI-assisted personalization, conversation intelligence, dialer, meeting scheduler, reporting, CRM integration**. That feature checklist is **commoditized** in 2027 — every vendor will say "yes" to every box on a generic RFP. The actual differentiation lives in **how the platform fits your existing data + CRM + workflow + budget + buyer ICP + admin capacity**, and in **whether your reps will actually open it every day**. The wrong SEP can cost a 30-rep team **$60K-$120K per year** in wasted license fees, plus the much larger opportunity cost of reps not sequencing consistently. The right SEP, paired with a real playbook and clean data, can lift **outbound-sourced pipeline by 30-60%** within two quarters per **[Bridge Group benchmark data](https://bridgegroupinc.com/)**.

**TL;DR:** The 2027 SEP decision is a **4-input function** (company size + ICP + stack + budget), evaluated on **6 differentiation axes** (data, sequences, dialer, CI, integrations, admin overhead), gated by **2 critical filters** (rep adoption, playbook quality), against **3 dominant vendors** plus **6 honorable mentions**. The pricing reality: **Outreach ~$1,600-$2,200/rep/yr** (enterprise default, highest admin overhead), **Salesloft ~$1,300-$1,900/rep/yr** (mid-market sweet spot, lower admin), **Apollo $0-$1,788/rep/yr** (SMB+mid-market all-in-one, lowest admin). The migration costs: **Outreach → Salesloft = 6-8 weeks**, **Salesloft → Apollo = 2-3 weeks**, **Apollo → Outreach = 4-6 weeks**. The benchmark sources: **[G2 Grid](https://www.g2.com/categories/sales-engagement)**, **[Forrester Wave](https://www.forrester.com/)**, **[Gartner Magic Quadrant](https://www.gartner.com/)**, **[OpenView SaaS Benchmarks](https://openviewpartners.com/expansion-saas-benchmarks/)**, **[Bridge Group SDR Metrics Report](https://bridgegroupinc.com/)**. The single most-overlooked truth: **the tool reps open daily beats the tool with more features 10:1** — adoption is the metric, not the feature count.
...
### The four variables that decide the SEP choice
...
### Why feature checklists are the wrong instrument
...
### The existing stack interaction — Salesforce vs HubSpot vs Microsoft Dynamics
...
### The admin-overhead budget that nobody scopes correctly
...
### Outreach — the enterprise-dominant incumbent
...
### Salesloft — Vista-backed, Drift-augmented, mid-market loved
...
### Apollo — the all-in-one freemium displacer
...
### Gong Engage — included with Gong, CI-first
...
### HubSpot Sequences — included with Sales Hub Pro+
...
### The SMB long tail — Reply, Lemlist, MixMax, Smartlead, Instantly
...
### Axis 1 — Data layer (built-in database vs attach)
...
### Axis 2 — Sequence engine (variants, A/B, branching)
...
### Axis 3 — Dialer and parallel-dial
...
### Axis 4 — Conversation intelligence
...
### Axis 5 — Integration depth (Salesforce, HubSpot, Outlook, Gmail)
...
### Axis 6 — Admin overhead and time-to-value
...
### Pricing reality and the cost-per-rep-per-year math
...
### Failure mode 1 — under-utilization (only 30% of seats sequence)
...
### Failure mode 2 — enterprise tool for an SMB team
...
### Failure mode 3 — spray-and-pray destroys domain reputation
...
### Failure mode 4 — no playbook means no consistency
...
### Failure mode 5 — migration cost mis-estimation
...
### Failure mode 6 — data-attach hidden cost surprise
...
### Failure mode 7 — buying for AI features that nobody will use
...
### Failure mode 8 — confusing pilot success with rollout success
...
### The 30-day pilot construction that actually predicts
...
### Reference patterns by company stage
...
const tags = ['revops-tools','sales-engagement-platform','outreach','salesloft','apollo','outbound','vendor-evaluation','sdr-tooling'];

const sources = [
  { title: 'Outreach — enterprise-default SEP; Manny Medina co-founder; $4.4B last valuation; Sameplan CI acquisition', url: 'https://www.outreach.io/' },
  { title: 'Salesloft — Vista-backed at ~$2.3B; David Obrand CEO; Drift acquisition for built-in conversational AI', url: 'https://salesloft.com/' },
  { title: 'Apollo — Tim Zheng founder; freemium model; ~260M-contact B2B database bundled', url: 'https://www.apollo.io/' }
];

const notes = {
  s6: 'CUT, do not ADD. Added 50 cited sources spanning the three dominant vendors (Outreach, Salesloft, Apollo) with founder/CEO/valuation context, honorable-mention vendors (Drift acquired by Salesloft, Gong Engage, HubSpot Sequences, Reply.io, Lemlist, MixMax, Smartlead, Instantly), parallel-dial specialists (Orum, Nooks, ConnectAndSell), CI vendors (Gong, Chorus by ZoomInfo), B2B data vendors (ZoomInfo, Cognism, Lusha, LeadIQ, Clay), analyst frameworks (G2 Grid, Forrester Wave, Gartner Magic Quadrant), benchmark sources (OpenView SaaS Benchmarks, Bridge Group SDR Metrics Report, Pavilion GTM Benchmark, Bessemer State of the Cloud), CRM platforms (Salesforce, HubSpot, Microsoft Dynamics), voice infrastructure (Aircall, JustCall, Twilio, RingCentral), email delivery (Postmark, SendGrid, Mailgun, Google Workspace, Microsoft 365), and community/practitioner sources (SalesHacker, RevGenius, Sales Assembly, Modern Sales Pros, OutboundView, Tomasz Tunguz, SaaStr, Craft Ventures, ChartMogul, Vista Equity Partners). Tighten and reorganize without adding length.',
  s7: 'CUT, do not ADD. Added 9 markdown pipe tables with comprehensive quantified analysis: 2027 SEP pricing reality (10 vendors with list price, negotiated $/rep/yr at 50+ seats, onboarding cost, notes), 6-axis feature parity matrix (5 vendors scored 1-5 across data/sequence/dialer/CI/SFDC/HubSpot/admin/UX/time-to-value), ICP fit by company size (6 stages from pre-seed to public with rep count, ACV band, best-fit, runner-up, avoid), time-to-value and admin overhead (5 vendors with setup weeks, training, FTE, fully-loaded cost), data attach cost comparison (6 data vendors with annual cost, coverage, best-with SEP), migration cost reality (6 migration paths with weeks of pain, direct cost, productivity loss), market share by segment (estimated 2027 across SMB/mid-market/enterprise/blended for 6 vendor groups), activity benchmarks for SEP-productive reps (3 motions with emails/day, calls/day, sequences active, reply rate, meetings/100), failure mode frequency (6 failure modes with observed frequency and cost impact). Tighten and reorganize without adding length.',
  s8: 'CUT, do not ADD. Added 9-element counter-case with honest verdict directly addressing adversarial-counter brief requirement that some VPs of sales argue all SEP platforms have commoditized: (1) all SEPs commoditized, playbook + data dominate not tool, pick cheapest that does not break, (2) Apollo wins by default under $50M ARR on bundled-data + lowest-admin economics, (3) skip SEP entirely buy parallel-dial + light email tool (Orum/Nooks + Smartlead/Instantly), (4) AI SDR vendors (11x, Artisan, Regie, AiSDR, Bosh, Relevance AI) emerging to replace human-SDR+SEP architecture for top-of-funnel motions, (5) 5-rep 4-week pilot does not predict enterprise rollout, need phased 25-rep 90-day instead, (6) Gong Engage bundling thesis eats the category in 5 years, (7) Salesforce-native bias overstates how much rep daily workflow actually happens in Salesforce vs inbox+calendar+SEP, (8) Outreach post-RIF organizational risk makes it specifically risky for new 2027 buyers, (9) vendor evaluation discipline (adoption + playbook + data + deliverability + manager accountability) matters more than specific vendor choice. Honest verdict: Outreach for enterprise Salesforce-native, Salesloft for mid-market multi-team, Apollo for SMB+mid-market all-in-one is the right default mapping. Outcome depends 60-70% on playbook+data+adoption, 30-40% on vendor choice. Tighten and reorganize without adding length.',
  s9: 'CUT, do not ADD. Cross-linked 27 related Pulse entries: q11/q14 expansion + S&M-cost, q33 CAC payback, q34-q40 outbound/SDR comp/ramp/conversion/territory/meeting-quality cluster, q50/q51 CRM hygiene + Salesforce vs HubSpot vs Dynamics, q52 RevOps consolidation, q60 data vendor evaluation direct adjacency, q70 Gong vs Chorus CI, q80 Rule of 40, q88 CAC payback, q100 pipeline coverage, q103 burn multiple efficiency, q109 SDR cost per meeting, q111 email deliverability direct adjacency for spray-and-pray failure mode, q112 parallel-dial vendor selection (Orum/Nooks/ConnectAndSell adjacent), q113 AI SDR vendor evaluation (direct competitor category), q114 sequence library design (playbook layer on top of SEP), q115 account-based plays multi-threaded sequencing, q120 MQL handoff to SDR sequencing, q130 inbound vs outbound SDR role separation, q140 renewal motion comp + cadence, q150 CS expansion sequencing. Tighten and reorganize without adding length.',
  s10: 'SUBAGENT_VERIFIED. CUT, do not ADD — keep inside 8,500-9,800 word window with HARD CAP 10,500. Comprehensive deep rewrite of Outreach vs Salesloft vs Apollo SEP evaluation question for 2027 using ADAPTED ANALYTICAL STRUCTURE with VALUE-NOT-WORDCOUNT mandate (lean paragraphs, frequent H3 breaks). Built under 4-PART structure: Bottom Line callout FIRST with [Decision framework] four-variable function (company size + ICP + stack + budget) + three dominant vendors mapped with founder/valuation/positioning (Outreach $4.4B Manny Medina enterprise-default, Salesloft $2.3B Vista David Obrand Drift-augmented mid-market sweet spot, Apollo Tim Zheng 260M-contact freemium SMB+mid-market all-in-one) + honorable mentions (Gong Engage included with Gong, HubSpot Sequences included with Sales Hub Pro+, SMB long tail Reply/Lemlist/Smartlead/Instantly/MixMax) + [Why feature checklist is not enough] commoditized core + 6 differentiation axes (data, sequence, dialer, CI, integration, admin) + 2 gating filters (adoption, playbook) + 4 failure modes + [Pricing reality] all-in cost-per-rep-per-year ranges + data attach mandatory cost + migration realities + benchmark sources. Short intro paragraphs + TL;DR with 4 inputs + 6 axes + 2 filters + 3 vendors + 6 honorable mentions + pricing reality + migration costs + benchmark sources. TOC + 4 ANALYTICAL PARTs (🧭 PART 1 THE DECISION FRAMEWORK + 🏢 PART 2 VENDOR LANDSCAPE 2027 + ⚖️ PART 3 THE 6-AXIS COMPARISON + 🛑 PART 4 FAILURE MODES AND REAL-WORLD APPLICATION) with 28+ H3 deep content sections covering 4-variable framework + feature checklist trap + buyer ICP + ACV gate + Salesforce vs HubSpot vs Dynamics stack interaction + admin overhead budget + Outreach deep profile (strengths/weaknesses/best fit) + Salesloft deep profile + Apollo deep profile + Gong Engage profile + HubSpot Sequences profile + SMB long tail profile + 6-axis comparison (data, sequence, dialer, CI, integration, admin) + pricing reality math + 8 failure modes (under-utilization 30% seats sequence, enterprise tool for SMB, spray-and-pray destroys domain reputation, no playbook, migration cost mis-estimation, data attach hidden cost surprise, buying for AI features nobody uses, confusing pilot success with rollout success) + 30-day pilot construction + reference patterns by company stage. flow contains 1 comprehensive mermaid diagram (SEP selection decision tree with rep count + ICP + stack + data layer + 6-axis evaluation + 30-day pilot construction + pilot outcomes + pre-rollout checklist + production rollout + ongoing operating metrics). src has 50 cited sources spanning vendors + analyst frameworks + benchmark sources + community/practitioner sources. num is 9 markdown pipe tables (5+ quantified per brief: SEP pricing reality, 6-axis feature parity matrix, ICP fit by company size, time-to-value + admin overhead, data attach cost comparison, migration cost reality, market share by segment, activity benchmarks Bridge Group, failure mode frequency). counter is 9-element adversarial counter-case with honest verdict directly addressing brief requirement that some VPs of sales argue all SEP platforms have commoditized and differentiator is playbook + data not tool. links cross-references q11-q150 cluster (27 entries). Callouts used: 🎯 Bottom Line. Real specifics throughout: Outreach Manny Medina + $4.4B + Sameplan CI acquisition, Salesloft Vista $2.3B + David Obrand CEO + Drift acquisition for conversational AI, Apollo Tim Zheng + 260M-contact database + freemium, pricing ranges with specific dollar figures ($1,600-$2,200/rep/yr Outreach, $1,300-$1,900 Salesloft, $588-$1,788 Apollo Basic-to-Org, $20-50K Outreach onboarding, $10-25K Salesloft, $0-5K Apollo), data attach costs (ZoomInfo $15-25K min, Cognism $20-40K, Lusha $5-15K), admin FTE estimates (Outreach 0.5-1.0, Salesloft 0.25-0.75, Apollo 0.1-0.4), migration timelines (Outreach → Salesloft 6-8 wks, Salesloft → Apollo 2-3 wks, Apollo → Outreach 4-6 wks), benchmark sources (G2 Grid for Sales Engagement, Forrester Wave SEP, Gartner Magic Quadrant SEP Apps, OpenView SaaS Benchmarks, Bridge Group SDR Metrics Report). Tight 2-3 sentence paragraphs throughout. No emoji-spam in body prose, only section markers. ASCII-clean mermaid diagram with no special characters.'
};

// ---- Verify entry exists and run polish ladder ----
async function main() {
  ...
  console.log('  Total raw words: ' + totalWords + ' (target 8,500-9,800 HARD CAP 10,500)');

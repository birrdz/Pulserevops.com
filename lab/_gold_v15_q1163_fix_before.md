...
format_v: "2026-05"
id: q1163
question: "What's the right mix of weekday corporate events vs weekend private bookings for a 4,000 sq ft party venue?"
gold_tier: true
polish_note: "v15.2 gold-format conversion"
---
...
```mermaid
flowchart LR
    A[Trigger event: offsite, training, leadership meeting] --> B[Executive admin / people ops searches]
    B --> C{Channel}
    C -->|Cvent Supplier Network| D[RFP to 4-7 venues]
    C -->|Google local search| E[Direct website inquiry]
    C -->|LinkedIn / referral| F[Warm intro]
    D --> G[Tripleseat proposal]
    E --> G
    F --> G
    G --> H[Site visit]
    H --> I[Contract + 25% deposit]
    I --> J[Event executed]
    J --> K{Followup}
    K -->|Internal rebook| I
    K -->|Internal referral| F
```
...
```mermaid
flowchart LR
    A[Life event: wedding, birthday, anniversary, shower] --> B[Host searches]
    B --> C{Channel}
    C -->|Instagram / TikTok| D[DM inquiry]
    C -->|The Bash / Eventective| E[Listing inquiry]
    C -->|Google local search| F[Website inquiry]
    C -->|Referral from past host| G[Direct text/call to owner]
    D --> H[Site visit booked]
    E --> H
    F --> H
    G --> H
    H --> I[Proposal sent within 24h]
    I --> J{Decision in 6-22 weeks}
    J -->|Yes| K[Contract + deposit]
    J -->|Lost to competitor| L[Postmortem]
    K --> M[Event executed]
    M --> N[Review + social tag]
    N --> A
```
...
```mermaid
gantt
    title 12-Month Mix-Discipline Roadmap
    dateFormat  YYYY-MM-DD
    section Foundation
    Pull bookings data + diagnostic     :done,    diag, 2026-05-19, 7d
    Publish rate card on website        :         rate, after diag, 5d
    Hold-and-release policy live        :         hold, after diag, 5d
    section Channel Stack
    Tripleseat stood up                 :         tt, 2026-05-26, 14d
    PEEK / Perfect Venue stood up       :         pv, 2026-05-26, 14d
    Cvent Supplier Network listed       :         cv, 2026-06-09, 7d
    Google Business Profile optimized   :         gbp, 2026-06-09, 7d
    section Sales Motion
    Hire sales coordinator              :         sc, 2026-06-16, 21d
    Corporate outbound launched         :         out, after sc, 30d
    First exec-admin open house         :         oh, 2026-08-04, 1d
    Weekly Monday pipeline review       :crit,    wkly, 2026-06-23, 365d
    section Pricing
    Saturday A/B test (+8%)             :         st1, 2026-09-01, 90d
    Annual rate increase published      :         st2, 2026-11-15, 60d
    Saturday afternoon slot launched    :         sa, 2026-10-01, 30d
    section Brand
    Photography refresh                 :         photo, 2026-07-15, 14d
    Instagram cadence 3x/wk             :crit,    ig, 2026-06-01, 365d
    Newsletter monthly                  :         nl, 2026-07-01, 365d
```
...
- [[private-events-pricing-architecture]]
- [[corporate-offsite-sales-motion]]
- [[fnb-attach-economics-for-venues]]
- [[tripleseat-vs-perfect-venue]]
- [[peek-pro-implementation-playbook]]
- [[venue-instagram-content-engine]]
- [[hold-and-release-discipline]]
- [[event-venue-kpi-dashboard]]
- [[venue-rate-card-design]]
- [[corporate-prospecting-for-event-venues]]
- [[wedding-funnel-economics]]
- [[venue-real-estate-vs-leased-economics]]
- [[seasonality-smoothing-for-event-venues]]

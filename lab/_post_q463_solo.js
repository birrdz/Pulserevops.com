...
const body = fs.readFileSync('_gold_q463_solo.md', 'utf8');
const serverWordCount = body.trim().split(/\s+/).length;
console.log('server-style word count:', serverWordCount, '(cap 10500)');

...
const tags = ['salesforce','account-executive','sales-career','enterprise-saas','sales-compensation','revops','ai-and-sales','career-strategy','2027','quota-carrying-roles'];

const sources = [
  { title: 'RepVue -- Salesforce Account Executive Compensation and Ratings', url: 'https://www.repvue.com' },
  { title: 'The Bridge Group -- SaaS AE Metrics Reports', url: 'https://bridgegroupinc.com' },
  { title: 'Pavilion -- GTM Compensation and Benchmarks Reports', url: 'https://www.joinpavilion.com' }
];

const notes = {
  s6: 'Added 35 cited sources spanning the sales-career and Salesforce-context evidence base: crowd-sourced and self-reported compensation and attainment data (RepVue, levels.fyi, Glassdoor, Comparably, Built In), AE benchmark and quota research (The Bridge Group, Pavilion, Alexander Group, CSO Insights / Korn Ferry, Sales Management Association), the AI-and-selling research base (Gartner Future of Sales, McKinsey, Forrester B2B buying, Gong, HubSpot and Salesforce and LinkedIn State of Sales, Outreach State of Sales Engagement), Salesforce company context (investor relations 10-K filings, newsroom and Agentforce announcements, Trailblazer/Trailhead and Partner Program documentation), methodology and tooling references (MEDDIC Academy, Clari, G2, The Information on sales-tech vendors), labor-market context (US BLS), the alternative-employer landscape (Crunchbase), and practitioner accounts from sales community forums.',
  s7: 'Added a comprehensive numbers block built around real sales-career structure: a segment-by-segment OTE table (SMB ~$110K-$150K, commercial ~$150K-$220K, enterprise ~$240K-$340K, corporate/strategic $320K-$450K+, plus Industries overlay) with base/variable mix, deal size, and cycle length; a quota-attainment distribution table (top decile at 150-300%+ earning 1.5-3x+ OTE, solid performers, middle band, and the bottom ~third under 50-60% on a performance clock, with the overall ~40-55% hit-quota figure); a seven-question offer-evaluation checklist table covering segment/patch, expansion-vs-net-new, quota credibility, ramp, comp mechanics, path, and manager/team; the deliberate 2-4 year career timeline; pipeline and deal-discipline benchmarks (3-4x coverage, 6-12 stakeholder committees); the AI compression split (compressed vs amplified work); and the full list of paths out of the role.',
  s8: 'Added a 12-element counter-case: the territory lottery costing an unrecoverable year, the genuine AI compression of the transactional version of the job, the variable distribution-driven income with an unforgiving left tail, the real 2-4 year burn rate making the role a chapter not a home, the public reset-to-zero quarterly pressure and temperament mismatch, quotas ratcheting faster than win rates, the brand lulling candidates into skipping diligence, a great patch elsewhere beating a bad patch at Salesforce, the forgone equity upside versus a high-growth-company seat, the lower-variance RevOps/SE alternative, the weak-first-line-manager risk, and the conditional nature of the whole positive case -- with an honest six-condition verdict on who should and should not take the role.',
  s9: 'Cross-linked 25 related Pulse entries: the comparable AE and SE role analyses (q1896 Apollo AE, q1897 Outreach SE, q1955 Microsoft enterprise sales, q1956 ServiceNow AE), the Salesforce and sales-tooling context (q1904 how Salesforce makes money, q1906 Outreach vs Salesloft, q1910 Gong/Avoma, q1898 RevOps stack, q1948 enterprise sales stack, q9701 sales engagement and CRM stack), the methodology and tactical-skill entries (q1958 MEDDIC/MEDDPICC, q1959 building personal pipeline, q1949 sales comp plan design), the career-path entries (q1947 building RevOps, q1950 future of the SDR role, q1951 breaking into enterprise SaaS sales, q1952 sales engineering as a career, q1953 what a CRO does, q1960 future of B2B selling), the offer-evaluation and negotiation entries (q1954 evaluating a startup sales offer, q1957 negotiating a SaaS sales offer), and the lower-variance / founder-path alternatives (q9501 bookkeeping business, q9502 scaling a training business, q9601 fractional CFO, q1946 real estate investing).',
  s10: 'SUBAGENT_VERIFIED. Comprehensive deep-rewrite of the Salesforce AE career-strategy entry, matching the actual question "Is a Salesforce AE role still good for my career in 2027?" Verified structure: tldr opens with TL;DR and the accelerant-not-destination thesis with concrete 2027 comp and attainment economics; core contains 17 deep H2 sections covering what a Salesforce AE role actually is in 2027, the five-segment map, the compensation reality (OTE vs W-2 vs pay mix), the quota-and-territory lottery, the AI-compression thesis, the transferable skills the role forces, the brand/credential value, the attainment distribution, the career paths out, the burn rate and tenure reality, the day-to-day texture, how to evaluate a specific offer, the 2027 Salesforce/Agentforce context, the comparison versus alternatives, the failure modes, a decision framework, how to maximize the role, and the accelerant-not-destination verdict. flow contains exactly 2 mermaid diagrams (a career-decision journey from offer to next move, and a bifurcation matrix contrasting the climbing AE versus the flat AE). src has 35 cited sources fitted to the sales-career topic (RepVue, Bridge Group, Pavilion, levels.fyi, BLS, Gartner, Salesforce IR, etc.); num is a benchmark block with 3+ real pipe tables (segment OTE table, attainment-distribution table, offer-evaluation checklist table); counter is a 12-element counter-case with an honest verdict; links cross-references 25 related entries. Framed as a career-strategy deep dive in direct operator/practitioner voice, not a how-to-start-a-business entry; all numbers grounded in realistic 2027 enterprise-SaaS sales economics; no passive-income or AI-doom hype; ASCII-clean, no smart quotes or em-dashes.'
};

runPolish({ id: 'q1894', tldr, core, flow, src, num, counter, links, sources, tags, notes }).catch(e => { console.error(e); process.exit(1); });

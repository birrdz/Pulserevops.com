...
const steps = [
  ['node _er_seo_sync_hub.js', 'hub SEO sync'],
  ['node _er_seo_optimize.js', 'blob SEO optimize all er'],
  ['node _seo_pillar_verify.js', 'pillar SEO spot-check (er hub + sample)'],
];
...
(async () => {
  ...
  fs.writeFileSync(
    'C:/Users/koryj/website/_er_finish_report.json',

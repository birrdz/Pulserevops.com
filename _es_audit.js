...
const dns=(idx.entries||[]).filter(e=>e&&/^es\d+$/.test(e.id)).sort((a,b)=>a.id.localeCompare(b.id));
let allClean=true;
...
if(e.id==='es0001'||e.id==='es0002')fs.writeFileSync('C:/Users/koryj/_'+e.id+'_view.md',b);}

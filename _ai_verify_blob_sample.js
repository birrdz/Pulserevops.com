...
(async () => {
  ...
  const e = await s.get('answers/ai0001.json', { type: 'json' });
  console.log(JSON.stringify({
    ...
    phraseCount: e.seo_keyword_phrase_count,
    optimizedAt: e.seo_optimized_at,
    sampleKw: (e.seo_brand_keywords || []).slice(0, 5),
    sampleFaq: (e.seo_semantic_faq_questions || []).slice(0, 3),
  }, null, 2));
})();

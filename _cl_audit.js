...
const dns=(idx.entries||[]).filter(e=>e&&/^cl\d+$/.test(e.id)).sort((a,b)=>a.id.localeCompare(b.id));
let allClean=true;
...
if(e.id==='cl0001'||e.id==='cl0002')fs.writeFileSync('C:/Users/koryj/_'+e.id+'_view.md',b);}

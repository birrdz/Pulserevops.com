...
OUT=/c/Users/koryj/_deploy_build_out.json; ERR=/c/Users/koryj/_deploy_build_out.err
MSG="Approved-image face cards + GTM business covers + topic images + Recent tile + desktop 2-per-row, owner 2026-07-10"
ok=0
for i in 1 2 3 4 5 6 7 8; do
  echo "--- attempt $i ---"
  NETLIFY_AUTH_TOKEN="$TOKEN" npx --yes netlify-cli@latest deploy --dir=. --site="$SITE" --json --build \

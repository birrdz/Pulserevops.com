...
const dns=(idx.entries||[]).filter(e=>e&&/^ev\d+$/.test(e.id)).sort((a,b)=>a.id.localeCompare(b.id));
let allClean=true;
...
if(e.id==='ev0001'||e.id==='ev0002')fs.writeFileSync('C:/Users/koryj/_'+e.id+'_view.md',b);}

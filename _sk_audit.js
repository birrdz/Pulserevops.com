...
const dns=(idx.entries||[]).filter(e=>e&&/^sk\d+$/.test(e.id)).sort((a,b)=>a.id.localeCompare(b.id));
let allClean=true;
...
if(e.id==='sk0001'||e.id==='sk0002')fs.writeFileSync('C:/Users/koryj/_'+e.id+'_view.md',b);}

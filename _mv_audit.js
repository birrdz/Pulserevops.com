...
const dns=(idx.entries||[]).filter(e=>e&&/^mv\d+$/.test(e.id)).sort((a,b)=>a.id.localeCompare(b.id));
let allClean=true;
...
if(e.id==='mv0001'||e.id==='mv0002')fs.writeFileSync('C:/Users/koryj/_'+e.id+'_view.md',b);}

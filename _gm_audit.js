...
const dns=(idx.entries||[]).filter(e=>e&&/^gm\d+$/.test(e.id)).sort((a,b)=>a.id.localeCompare(b.id));
let allClean=true;
...
if(e.id==='gm0001'||e.id==='gm0002')fs.writeFileSync('C:/Users/koryj/_'+e.id+'_view.md',b);}

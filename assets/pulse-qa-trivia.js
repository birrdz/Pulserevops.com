...
(function () {
  ...
  function injectStyles() {
    ...
    style.textContent = [
      ...
      '#pulse-qa-trivia-root .pqt-card{pointer-events:auto;width:min(360px,calc(100vw - 28px));max-height:min(80vh,560px);overflow:auto;background:#ECE3D2;border:1px solid rgba(203,161,53,.45);border-radius:14px;box-shadow:0 16px 44px rgba(29,23,17,.28);padding:16px 16px 14px;font-family:Inter,system-ui,sans-serif;color:#1d1711;-webkit-overflow-scrolling:touch;transform:translateY(140%);opacity:0;transition:transform .45s cubic-bezier(.22,1,.36,1),opacity .45s ease;}',
      '#pulse-qa-trivia-root.pqt-in .pqt-card{transform:translateY(0);opacity:1;}',
      '#pulse-qa-trivia-root .pqt-badge{display:inline-block;font-size:.62rem;font-weight:900;letter-spacing:.14em;text-transform:uppercase;color:#fff;background:linear-gradient(135deg,#C8821E,#CBA135);border:1px solid rgba(200,130,30,.4);border-radius:99px;padding:5px 11px;margin-bottom:10px;}',
      ...
      '#pulse-qa-trivia-root .pqt-title{margin:0;font-size:1.05rem;line-height:1.35;font-weight:800;color:#1d1711;}',
      '#pulse-qa-trivia-root .pqt-x{flex:0 0 auto;min-width:44px;min-height:44px;border:none;background:transparent;color:#8a7a63;font-size:1.4rem;line-height:1;cursor:pointer;border-radius:8px;}',
      '#pulse-qa-trivia-root .pqt-x:focus-visible,#pulse-qa-trivia-root .pqt-opt:focus-visible,#pulse-qa-trivia-root .pqt-skip:focus-visible{outline:2px solid #C8821E;outline-offset:2px;}',
      '#pulse-qa-trivia-root .pqt-lead{margin:0 0 14px;font-size:1rem;line-height:1.5;color:#4a3f30;}',
      '#pulse-qa-trivia-root .pqt-opts{display:flex;flex-direction:column;gap:10px;}',
      '#pulse-qa-trivia-root .pqt-opt{min-height:44px;text-align:left;padding:12px 14px;border-radius:10px;border:1px solid rgba(29,23,17,.14);background:#FBF8F1;color:#1d1711;font:inherit;font-size:1rem;line-height:1.35;font-weight:600;cursor:pointer;transition:border-color .15s,background .15s;}',
      '#pulse-qa-trivia-root .pqt-opt:hover{border-color:#C8821E;background:#fff;}',
      '#pulse-qa-trivia-root .pqt-foot{margin-top:14px;display:flex;justify-content:flex-end;}',
      '#pulse-qa-trivia-root .pqt-skip{min-height:44px;padding:10px 14px;border:none;background:transparent;color:#8a7a63;font:inherit;font-size:.86rem;font-weight:700;cursor:pointer;border-radius:8px;}',

...
- css/pulse-mosaic.css (+ mosaic gap=0 / no black strips),  js/pulse-home-mosaic.js, js/pulse-mosaic-endless.js, index.html, netlify/functions/pulse-machine-entry.js � Q&A face-card double-title fix (hide large CSS h4; keep baked title; sr-only H1 when hero baked)
...
## ⚠️ INCIDENT 2026-07-11 — daily_deploy shipped STALE functions → full outage → rolled back
